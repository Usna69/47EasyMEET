      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="bg-green-700 text-white px-6 py-4">
          ...
          <p className="text-green-100">
            Convert your Word documents to JPG for meeting letterheads
          </p>
        </div>
        ...
        <div className="p-6">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              This tool helps you convert Microsoft Word documents (DOCX) to JPG
              image format, which is required for letterheads and document
              uploads in EasyMEET.
            </p>
          </div>
          ...
          <div className="mb-6 p-4 bg-blue-50 rounded-md">
            ...
            <ol className="list-decimal pl-5 text-blue-700 space-y-2">
              ...
              <li>
                Click &quot;Convert to JPG&quot; to start the conversion process
              </li>
              <li>Download your converted JPG file when ready</li>
              <li>
                Optionally, add password protection to secure your document
              </li>
            </ol>
          </div>
            ...
            <div className="mt-8 border border-green-200 rounded-md p-4 bg-green-50">
              ...
              <div className="mt-4 bg-yellow-50 p-3 rounded-md border border-yellow-100">
                <p className="text-sm text-yellow-800">
                  <span className="font-medium">Note:</span> You can now use
                  this JPG file as a letterhead in your meeting setup.{" "}
                  {isProtected && "The file will be password-protected."}
                </p>
              </div>
            </div>
          )}
          ...
          <div className="mt-8 border-t pt-6">
            ...
            <p className="text-gray-600 mb-4">
              If you&apos;re having trouble with the built-in converter, you can
