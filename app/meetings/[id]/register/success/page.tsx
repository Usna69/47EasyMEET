...
// Type for the meeting data returned from the database
...
export default async function SuccessPage(props: SuccessPageParams) {
  ...
  // Fetch meeting using safeQuery instead of Prisma
  const query = `
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-white shadow-md rounded-lg p-8 border border-gray-100">
            ...
            <h1 className="text-2xl font-bold text-[#014a2f] mb-4">
              Registration Successful!
            </h1>
            <p className="text-gray-600 mb-8">
              You have successfully registered for the meeting:{" "}
              <span className="font-medium">{meeting.title}</span>. The meeting
              will take place on {formatDateConsistent(meeting.date)} in{" "}
              {meeting.location}.
            </p>
