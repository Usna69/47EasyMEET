          ...
          {isRegistrationOpen ? (
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md my-6">
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-yellow-700 font-medium">Registration not yet open</p>
                  <p className="text-sm text-yellow-600 mt-1">
                    You can register for this meeting once it starts at {new Date(meeting.date).toLocaleTimeString()} on {new Date(meeting.date).toLocaleDateString()}.
                  </p>
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded-md my-6">
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-red-700 font-medium">Registration period has ended</p>
                  <p className="text-sm text-red-600 mt-1">
                    Registration for this meeting closed at {registrationEndTime.toLocaleTimeString()} on {registrationEndTime.toLocaleDateString()}.
                  </p>
                  <p className="text-sm text-red-600 mt-3">
                    <Link href={`/meetings/${meeting.id}`} className="font-medium underline">Return to meeting details</Link>
                  </p>
