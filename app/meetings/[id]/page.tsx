        ...
        <div>
          ...
          {meeting.resources && meeting.resources.length > 0 && (
            <div className="bg-white shadow-md rounded-lg p-6 border border-gray-100 mt-6">
              <h2 className="text-xl font-semibold mb-4 text-[#014a2f]">Meeting Resources</h2>
              <p className="text-gray-600 mb-4">The following resources are available for download:</p>
              
              <div className="space-y-3">
                {meeting.resources.map((resource: any) => (
                  <div key={resource.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-md border border-gray-200">
                    <div className="flex items-center">
                      {/* File icon based on type */}
                      <div className="mr-3 bg-[#014a2f]/10 p-2 rounded-md">
                        {resource.fileType.includes('pdf') ? (
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#014a2f]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{resource.fileType}</p>
                      </div>
                    </div>
                    ...
                    <a 
                      ...
                      className="flex items-center px-3 py-1.5 text-sm font-medium text-[#014a2f] bg-[#014a2f]/10 rounded-md hover:bg-[#014a2f]/20 transition-colors"
                    >
