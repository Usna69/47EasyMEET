    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">View Meetings</h3>
              <p className="text-gray-600 mb-4">Browse available meetings and events for your level</p>
              <Link
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Create Meeting</h3>
              <p className="text-gray-600 mb-4">Schedule a new high-level meeting or event</p>
              <Link
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">My Registrations</h3>
              <p className="text-gray-600 mb-4">View your meeting registrations and attendance</p>
              <Link
        ...
        <div className="bg-white shadow-lg rounded-lg p-8">
          <h3 className="text-2xl font-semibold text-[#014a2f] mb-6">Portal Information</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-lg font-medium text-gray-800 mb-3">Access Level</h4>
            ...
            <div>
              <h4 className="text-lg font-medium text-gray-800 mb-3">Quick Tips</h4>
                             <ul className="list-disc list-inside text-gray-600 space-y-2">
