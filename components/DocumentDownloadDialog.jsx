...
export default function DocumentDownloadDialog({ isOpen, onClose, onDownload, resourceName, resourceId, hasPasswordProtection }) {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        <div className="p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Download Document</h3>
            <button
              onClick={onClose}
