...
export default function MeetingCard({ meeting }: { meeting: Meeting }) {
  return (
    <article className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow flex flex-col h-full">
      ...
      <div className="mt-auto pt-4 flex gap-2">
        ...
        <Link
          ...
          className="bg-[#FFC107] hover:bg-[#E0A800] text-[#014a2f] px-4 py-2 rounded-md font-medium transition-colors"
        >
          Register
        </Link>
      </div>
